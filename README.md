...
4. Enter your AI API key at the bottom of the site. Google Gemini currently has a free model available, with limited uses per day. You can easily create an API key for free with a Google account.
